...
BOT_TOKEN = "8172592311:AAHB84xXTD2Odh5ODhWN7Pqg2_YrW72Sy5M"
PAYMENT_CHANNEL = "@testpostchnl" #add payment channel here including the '@' sign
OWNER_ID = 5289529090 #write owner's user id here.. get it from @MissRose_Bot by /id
CHANNELS = ["@DNAFARM_BOT"] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
